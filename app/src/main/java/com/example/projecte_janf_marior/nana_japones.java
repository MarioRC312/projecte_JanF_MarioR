...
public class nana_japones extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nana_japones);
    ...
    public void onClick(View view) {
        ...
        if(boto.getId() == R.id.backBoton){
            ...
            intent2.putExtra(SearchManager.QUERY, "https://www.tripadvisor.es/Restaurant_Review-g670666-d14092572-Reviews-NANA_Restaurant_Japones-Granollers_Catalonia.html");
