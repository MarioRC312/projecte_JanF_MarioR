...
public class pure_cuisine extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pure_cuisine);
    ...
    public void onClick(View view) {
        ...
        if(boto.getId() == R.id.backBoton){
            ...
            intent2.putExtra(SearchManager.QUERY, "https://www.tripadvisor.es/Restaurant_Review-g187497-d23764070-Reviews-Pure_Cuisine_Mataro_Parc-Barcelona_Catalonia.html");
